...
class Bare:
    ...
    def observer(self, epoches, IL):
        ...
        for k in range(len(tasks)):
            ...
            self.model = train_node_classifier(self.model, task, self.opt, weight=None, n_epoch=epoches, incremental_cls=(0, num_cls+1))
        ...
        return AP, np.mean(APs), AF, performace_matrix